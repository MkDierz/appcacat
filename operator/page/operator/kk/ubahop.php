                                ...
                                <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                                    ...
                                    <fieldset disabled="disabled">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="Pilih Status Verifikasi">Pilih Status Verifikasi</option>
...
if (isset($_POST['save']))
{
    $koneksi->query("UPDATE db_kk SET opr='$_POST[opr]' WHERE id='$_GET[id]'");

echo "<script>alert(' Data Penduduk Berhasil Diubah :)');</script>";
echo "<script>location='index.php?page=operator';</script>";
    } 
    ?>
