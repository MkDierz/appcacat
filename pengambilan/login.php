...
<head>
    ...
    <title> Pengambilan Berkas : Login</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div class="container">
        <div class="row text-center ">
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                ...
                <h2> Pengambilan Berkas : Login</h2>
                        ...
                        <strong>   Masukkan Username & Password </strong> 
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                    ...
                                    {
                                      $ambil = $koneksi->query("SELECT * FROM db_adminpengkk WHERE username='$_POST[user]' AND password = '$_POST[pass]'");
                                      $adminasli = $ambil->num_rows;
                                      if ($adminasli==1)
                                      {
                                        $_SESSION['db_adminpengkk']=$ambil->fetch_assoc();
