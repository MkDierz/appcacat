...
if (!isset($_SESSION['db_adminkasikk']))
{
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">KASI</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                    <a  href="index.php?page=kasi"><i class="fa fa-briefcase fa-1x"></i>Verifikasi Kasi </a>
                    </li>
                    </ul>
                      </li>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                        ...
                        if (isset($_GET['page']))
                {
                    ...
                    if ($_GET['page']=="kasi")
                    {
                        include 'page/kasi/kk/kasi.php';
                    }
                    elseif ($_GET['page']=="ubahkasi")
                    {
                        include 'page/kasi/kk/ubahkasi.php';
                    }
