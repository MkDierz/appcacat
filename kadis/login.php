                        ...
                        <strong>   Masukkan Username & Password </strong> 
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                    ...
                                    {
                                      $ambil = $koneksi->query("SELECT * FROM db_adminkadiskk WHERE username='$_POST[user]' AND password = '$_POST[pass]'");
                                      $adminasli = $ambil->num_rows;
                                      if ($adminasli==1)
                                      {
                                        $_SESSION['db_adminkadiskk']=$ambil->fetch_assoc();
