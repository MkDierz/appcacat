...
if (!isset($_SESSION['db_adminkadiskk']))
{
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">KADIS</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                    <a  href="index.php?page=kadis"><i class="fa fa-briefcase fa-1x"></i> Tanda Tangan KK </a>
                    </li>
                    </ul>
                      </li>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                        ...
                        if (isset($_GET['page']))
                {
                    ...
                    if ($_GET['page']=="kadis")
                    {
                        include 'page/kadis/kk/kadis.php';
                    }
                    elseif ($_GET['page']=="ubahkadis")
                    {
                        include 'page/kadis/kk/ubahkadis.php';
                    }
